            ...
            <div>
               <div className="col-md-12 header">
                   ...
                   <div className="col-md-6 titlediv navDiv">
                       ...
                       <Link to="/AuthorsList" className="buttonmar"><button className="btn btn-info">Authors</button></Link>
                       <Link to="/BookList" className="buttonmar"><button className="btn btn-info">Books</button></Link>
